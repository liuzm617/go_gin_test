...
func GetQrCodePath() string {
	return conf.AppConf.QrCodeSavePath
}

// GetQrCodeFullPath get full save path
func GetQrCodeFullPath() string {
	return conf.AppConf.RuntimeRootPath + conf.AppConf.QrCodeSavePath
}

// GetQrCodeFullUrl get the full access path
func GetQrCodeFullUrl(name string) string {
	return conf.AppConf.PrefixUrl + "/" + GetQrCodePath() + name
}

// GetQrCodeFileName get qr file name
func GetQrCodeFileName(value string) string {
	return common.EncodeMD5(value)
}
